...
static int sgtl5000_probe(struct snd_soc_component *component)
{
	...
	//snd_soc_component_write(component, SGTL5000_CHIP_ANA_POWER, 0x6AFF);
	...
	snd_soc_component_update_bits(component, SGTL5000_CHIP_PLL_CTRL,
			0xF800,14<<11);
	snd_soc_component_update_bits(component, SGTL5000_CHIP_PLL_CTRL,
			0xF800,14<<11);
	...
	snd_soc_component_update_bits(component, SGTL5000_CHIP_SSS_CTRL,
			0x00C0,1<<6);
	snd_soc_component_update_bits(component, SGTL5000_CHIP_SSS_CTRL,
			0x0030,3<<4);
	snd_soc_component_update_bits(component, SGTL5000_CHIP_ANA_CTRL,
